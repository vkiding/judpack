...
module.exports = function() {
  it('Find XCode project', function() {
    expect(util.findXcodeProject('./judpackdemo/platform/ios')).to.equal(false);
    expect(typeof util.findXcodeProject('./judpackdemo/platform/ios') == 'object').to.equal(false);
  });
