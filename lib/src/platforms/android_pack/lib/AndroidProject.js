...
function getRelativeLibraryPath (parentDir, subDir) {
    ...
    console.log('JUDPACK' + __dirname + 'getRelativeLibraryPath:' + parentDir + ',' + subDir);
...
function AndroidProject(projectDir) {
    ...
    if(AndroidStudio.isAndroidStudioProject(projectDir) === true) {
      this.www = path.join(this.projectDir, 'judplugin/src/main/assets/www');
    }
}
...
AndroidProject.prototype.getPackageName = function() {
    ...
    if(utils.isJudPluginRoot(this.projectDir)){
