...
var cordova_util  = require('./util'),
    ...
    PluginInfoProvider = require('judpack-common').PluginInfoProvider,
...
module.exports = function plugin(command, targets, opts) {
    ...
    return Q().then(function () {
        ...
        var config_json = config.read(projectRoot);
         ...
         var platformList = [];
        if(cordova_util.isJudPluginRoot(projectRoot)){
       ...
       // JUD_HOOK
        ...
        switch(command) {
            case 'add':
                ...
                //创建一个新的
                if(!xml&&cordova_util.isJudPluginRoot(projectRoot)){
