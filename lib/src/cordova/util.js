...
exports.isJudPluginRoot = isJudPluginRoot;
...
function isJudPluginRoot(dir){

    if(exports.existsSync(dir)&&/Judplugin$/.test(dir)){
        return true
    }
}

function isIOSProject(dir){
    if (exports.existsSync(path.join(dir, 'Judplugin.xcodeproj'))) {
        return true
    }
}
