...
function platformFromName(name) {
    var platMatch = /^judpack-([a-z0-9-]+)$/.exec(name);
        ...
        if (targets) {
            ...
            targets.forEach(function (t) {
                ...
                if (/[~:/\\.]/.test(t)) {
                    ...
                    msg = 'Platform "' + t +
                        '" not recognized as a core judpack platform. See `' +
                        cordova_util.binname + ' platform list`.'
                    ;
                }
